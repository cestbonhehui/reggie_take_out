...
![image-20210803125619732.png](../../../../_resources/image-20210803125619732.png)
...
在文件上传成功后，在 **handleAvatarSuccess 方法**中获取文件上传成功之后返回的数据(文件名)，然后调用 **/common/download?name=xxx** 进行文件的下载。
